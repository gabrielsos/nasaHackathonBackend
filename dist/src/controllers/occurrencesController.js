...
var OccurrencesController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, connection_1.default('occurrences').insert({
                                loginName: loginName,
                                latitude: latitude,
                                longitude: longitude,
    ...
    OccurrencesController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var occurrences;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, connection_1.default('occurrences').select('*')];
                    case 1:
                        occurrences = _a.sent();
                        return [2 /*return*/, response.json(occurrences)];
                }
            });
        });
    };
    return OccurrencesController;
}());
exports.default = OccurrencesController;
